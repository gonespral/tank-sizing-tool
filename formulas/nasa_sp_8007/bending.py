...
# Out of curiosity, this equation comes from NASA as well, but before they did the research on the KDF

# def test_bending(p, r, t, l, E, v):
# """
# Shell bending formula from NASA SP-8007, with outdated knockdown factors.
...
# :param v: poisson's ratio
# :param L: length
# :return: Critical Bending Load (collapse load)
# """

# p_prim = np.sqrt(12 * (1 - v ** 2)) * p / E * (r / t) ** 2
# M_coll = p * np.pi * r ** 3 * (1 + 1 / p_prim)
